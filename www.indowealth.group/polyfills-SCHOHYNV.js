...
function dt() {
    ...
    let Y = class Y {
        static assertZonePatched() {
            if (ae.Promise !== S.ZoneAwarePromise) throw new Error("Zone.js has detected that ZoneAwarePromise `(window|global).Promise` has been overwritten.\nMost likely cause is that a Promise polyfill has been loaded after Zone.js (Polyfilling Promise api is not necessary when zone.js is loaded. If you must load one, do so before loading zone.js.)")
        }
        static get root() {
            let i = Y.current;
        ...
        constructor(i, s) {
            this._parent = i, this._name = s ? s.name || "unnamed" : "<root>", this._properties = s && s.properties || {}, this._zoneDelegate = new f(this, this._parent && this._parent._zoneDelegate, s)
        }
        get(i) {
        ...
        runTask(i, s, o) {
            if (i.zone != this) throw new Error("A task can only be run in the zone of creation! (Creation: " + (i.zone || K).name + "; Execution: " + this.name + ")");
            let p = i,
                {
                    type: H,
                    data: {
            ...
            try {
                ...
                if (ne !== q && ne !== X)
                    if (H == z || M || se && ne === k) le && p._transitionTo(d, Z, k);
                        ...
                        this._updateTaskCount(p, -1), le && p._transitionTo(q, Z, q), se && (p._zoneDelegates = h)
                    }
                b = b.parent, D = ue
            }
        }
        scheduleTask(i) {
            if (i.zone && i.zone !== this) {
                let o = this;
                for (; o;) {
                    if (o === i.zone) throw Error(`can not reschedule task to ${this.name} which is descendants of the original zone ${i.zone.name}`);
                    o = o.parent
                }
            }
            i._transitionTo(k, q);
            ...
            try {
                ...
                throw i._transitionTo(X, k, q), this._zoneDelegate.handleError(this, o), o
            }
            return i._zoneDelegates === s && this._updateTaskCount(i, 1), i.state == k && i._transitionTo(d, k), i
        }
        ...
        cancelTask(i) {
            if (i.zone != this) throw new Error("A task can only be cancelled in the zone of creation! (Creation: " + (i.zone || K).name + "; Execution: " + this.name + ")");
            if (!(i.state !== d && i.state !== Z)) {
                i._transitionTo(V, d, Z);
                try {
                    this._zoneDelegate.cancelTask(this, i)
                } catch (s) {
                    throw i._transitionTo(X, V), this._zoneDelegate.handleError(this, s), s
                }
                return this._updateTaskCount(i, -1), i._transitionTo(q, V), i.runCount = -1, i
            }
        }
    ...
    class f {
        ...
        constructor(i, s, o) {
            this._taskCounts = {
                ...
                macroTask: 0,
                eventTask: 0
            }, this._zone = i, this._parentDelegate = s, this._forkZS = o && (o && o.onFork ? o : s._forkZS), this._forkDlgt = o && (o.onFork ? s : s._forkDlgt), this._forkCurrZone = o && (o.onFork ? this._zone : s._forkCurrZone), this._interceptZS = o && (o.onIntercept ? o : s._interceptZS), this._interceptDlgt = o && (o.onIntercept ? s : s._interceptDlgt), this._interceptCurrZone = o && (o.onIntercept ? this._zone : s._interceptCurrZone), this._invokeZS = o && (o.onInvoke ? o : s._invokeZS), this._invokeDlgt = o && (o.onInvoke ? s : s._invokeDlgt), this._invokeCurrZone = o && (o.onInvoke ? this._zone : s._invokeCurrZone), this._handleErrorZS = o && (o.onHandleError ? o : s._handleErrorZS), this._handleErrorDlgt = o && (o.onHandleError ? s : s._handleErrorDlgt), this._handleErrorCurrZone = o && (o.onHandleError ? this._zone : s._handleErrorCurrZone), this._scheduleTaskZS = o && (o.onScheduleTask ? o : s._scheduleTaskZS), this._scheduleTaskDlgt = o && (o.onScheduleTask ? s : s._scheduleTaskDlgt), this._scheduleTaskCurrZone = o && (o.onScheduleTask ? this._zone : s._scheduleTaskCurrZone), this._invokeTaskZS = o && (o.onInvokeTask ? o : s._invokeTaskZS), this._invokeTaskDlgt = o && (o.onInvokeTask ? s : s._invokeTaskDlgt), this._invokeTaskCurrZone = o && (o.onInvokeTask ? this._zone : s._invokeTaskCurrZone), this._cancelTaskZS = o && (o.onCancelTask ? o : s._cancelTaskZS), this._cancelTaskDlgt = o && (o.onCancelTask ? s : s._cancelTaskDlgt), this._cancelTaskCurrZone = o && (o.onCancelTask ? this._zone : s._cancelTaskCurrZone), this._hasTaskZS = null, this._hasTaskDlgt = null, this._hasTaskDlgtOwner = null, this._hasTaskCurrZone = null;
            let p = o && o.onHasTask,
                H = s && s._hasTaskZS;
            (p || H) && (this._hasTaskZS = p ? o : c, this._hasTaskDlgt = s, this._hasTaskDlgtOwner = this, this._hasTaskCurrZone = this._zone, o.onScheduleTask || (this._scheduleTaskZS = c, this._scheduleTaskDlgt = s, this._scheduleTaskCurrZone = this._zone), o.onInvokeTask || (this._invokeTaskZS = c, this._invokeTaskDlgt = s, this._invokeTaskCurrZone = this._zone), o.onCancelTask || (this._cancelTaskZS = c, this._cancelTaskDlgt = s, this._cancelTaskCurrZone = this._zone))
        }
        fork(i, s) {
        ...
        scheduleTask(i, s) {
            let o = s;
            if (this._scheduleTaskZS) this._hasTaskZS && o._zoneDelegates.push(this._hasTaskDlgtOwner), o = this._scheduleTaskZS.onScheduleTask(this._scheduleTaskDlgt, this._scheduleTaskCurrZone, i, s), o || (o = s);
        ...
        cancelTask(i, s) {
            let o;
            if (this._cancelTaskZS) o = this._cancelTaskZS.onCancelTask(this._cancelTaskDlgt, this._cancelTaskCurrZone, i, s);
            else {
    ...
    class E {
        constructor(i, s, o, p, H, M) {
            if (this._zone = null, this.runCount = 0, this._zoneDelegates = null, this._state = "notScheduled", this.type = i, this.source = s, this.data = p, this.scheduleFn = H, this.cancelFn = M, !o) throw new Error("callback is not defined");
            this.callback = o;
            let se = this;
        ...
        _transitionTo(i, s, o) {
            if (this._state === s || this._state === o) this._state = i, i == q && (this._zoneDelegates = null);
            else throw new Error(`${this.type} '${this.source}': can not transition to '${i}', expecting state '${s}'${o?" or '"+o+"'":""}, was '${this._state}'.`)
        }
        toString() {
...
var nt = typeof WorkerGlobalScope < "u" && self instanceof WorkerGlobalScope,
    ...
    Ye = function(e) {
        ...
        } else c = t && t.apply(this, arguments), e.type === "beforeunload" && $[mt] && typeof c == "string" ? e.returnValue = c : c != null && !c && e.preventDefault();
        return c
    };
...
function $e(e, n, a) {
    ...
    let f = t.get,
        ...
        T = n.slice(2),
        m = Ce[T];
    m || (m = Ce[T] = A("ON_PROPERTY" + T)), t.set = function(C) {
        let _ = this;
        if (!_ && e === $ && (_ = $), !_) return;
        typeof _[m] == "function" && _.removeEventListener(T, Ye), E && E.call(_, null), _[m] = C, typeof C == "function" && _.addEventListener(T, Ye, !1)
    }, t.get = function() {
        let C = this;
...
function ve(e) {
    ...
    for (t in a) e === "XMLHttpRequest" && t === "responseBlob" || function(c) {
        typeof a[c] == "function" ? $[e].prototype[c] = function() {
            ...
            set: function(f) {
                typeof f == "function" ? (this[oe][c] = Ve(f, e + "." + c), _e(this[oe][c], f)) : this[oe][c] = f
            },
            get: function() {
                return this[oe][c]
            }
    ...
    function K(k, d) {
        ...
        function Y(r, u) {
            return !me && typeof r == "object" && r ? !!r.capture : !me || !u ? r : typeof r == "boolean" ? {
                capture: r,
                passive: !0
            } : r ? typeof r == "object" && r.passive !== !1 ? { ...r,
                passive: !0
            } : r : {
                passive: !0
            }
        ...
        let j = function(r) {
                if (!S.isExisting) return w.call(S.target, S.eventName, S.capture ? J : U, S.options)
            },
            i = function(r) {
                if (!r.isRemoved) {
                    ...
                    if (R) {
                        for (let y = 0; y < R.length; y++)
                            if (R[y] === r) {
                                R.splice(y, 1), r.isRemoved = !0, r.removeAbortListener && (r.removeAbortListener(), r.removeAbortListener = null), R.length === 0 && (r.allRemoved = !0, r.target[v] = null);
                                break
                            }
                    }
                }
                if (r.allRemoved) return b.call(r.target, r.eventName, r.capture ? J : U, r.options)
            },
            s = function(r) {
            ...
            return function() {
                ...
                if (ue) {
                    for (let ce = 0; ce < ue.length; ce++)
                        if (L === ue[ce]) return Ee ? r.call(N, L, F, ie) : r.apply(this, arguments)
                }
                ...
                if (ge) {
                    if (We = !0, X) {
                        for (let ce = 0; ce < ge.length; ce++)
                            if (le(ge[ce], F)) return
                    }
                } else ge = N[ze] = [];
                let we, qe = N.constructor.name,
                    Xe = st[qe];
                Xe && (we = Xe[L]), we || (we = qe + u + (z ? z(L) : L)), S.options = ie, Ue && (S.options.once = !1), S.target = N, S.capture = Oe, S.eventName = L, S.isExisting = We;
                let ke = Z ? bt : void 0;
                ...
                if (S.target = null, ke && (ke.taskData = null), Ue && (S.options.once = !0), !me && typeof re.options == "boolean" || (re.options = ie), re.target = N, re.capture = Oe, re.eventName = L, B && (re.originalDelegate = F), O ? ge.unshift(re) : ge.push(re), y) return N
            }
        };
        return g[c] = l(w, C, H, M, G), W && (g[_] = l(W, P, o, M, G, !0)), g[f] = function() {
            let r = this || e,
                u = arguments[0];
            ...
            if (G) return this
        }, _e(g[c], w), _e(g[f], b), Q && _e(g[T], Q), D && _e(g[E], D), !0
    }
    let q = [];
...
function ye(e, n, a, t) {
    ...
    c = de(e, n, C => function(_, P) {
        if (Ke(P[0])) {
            ...
            if (J) E[J] = U;
                ...
                K.refresh = function() {
                    ...
                    return V === "notScheduled" ? (U._state = "scheduled", Z._updateTaskCount(U, 1)) : V === "running" && (U._state = "scheduling"), d.call(this)
                }
            }
            return K ? ? J ? ? U
        ...
        let I = P[0],
            x;
        Qe(I) ? (x = E[I], delete E[I]) : (x = I ? .[Re], x ? I[Re] = null : x = I), x ? .type ? x.cancelFn && x.zone.cancelTask(x) : C.apply(e, P)
    })
}
...
function Nt(e) {
    e.__load_patch("legacy", n => {
                        ...
                        if (!b.aborted && D[E] && w.state === q) {
                            ...
                            if (D.status !== 0 && j && j.length > 0) {
                                ...
                                w.invoke = function() {
                                    ...
                                    for (let o = 0; o < s.length; o++) s[o] === w && s.splice(o, 1);
                                    !b.aborted && w.state === q && i.call(w)
                                }, j.push(w)
                            } else w.invoke()
                        } else !b.aborted && D[E] === !1 && (D[m] = !0)
                };
                return U.call(D, K, W), D[t] || (D[t] = w), z.apply(D, b.args), D[E] = !0, w
            }
        ...
        n.PromiseRejectionEvent && (a[A("unhandledPromiseRejectionHandler")] = t("unhandledrejection"), a[A("rejectionHandledHandler")] = t("rejectionhandled"))
    ...
    e.__load_patch("ZoneAwarePromise", (n, a, t) => {
        ...
        function Y(h, l, r) {
            ...
            if (h[k] === g) {
                ...
                if (l !== S && r instanceof M && r.hasOwnProperty(k) && r.hasOwnProperty(d) && r[k] !== g) i(r), Y(h, r[k], r[d]);
                    ...
                    h[k] = l;
                    let R = h[d];
                    if (h[d] = r, h[Z] === Z && l === z && (h[k] = h[X], h[d] = h[V]), l === S && r instanceof Error) {
...
` + r.stack : ""))
                        ...
                        C && (y.throwOriginal = !0), y.rejection = r, y.promise = h, y.zone = a.current, y.task = a.currentTask, m.push(y), t.scheduleMicroTask()
                    }
                }
            }
            return h
        ...
        class M {
            ...
            static any(l) {
                if (!l || typeof l[Symbol.iterator] != "function") return Promise.reject(new H([], "All promises were rejected"));
                let r = [],
                    u = 0;
                try {
                ...
                if (u === 0) return Promise.reject(new H([], "All promises were rejected"));
                let v = !1,
                    R = [];
                return new M((y, O) => {
                    for (let N = 0; N < r.length; N++) r[N].then(L => {
                        ...
                        R.push(L), u--, u === 0 && (v = !0, O(new H(R, "All promises were rejected")))
                    })
                })
            }
            static race(l) {
        ...
        return se && (ue(se), de(n, "fetch", h => ne(h))), Promise[a.__symbol__("uncaughtPromiseErrors")] = m, M
    })
}
        ...
        return m && m.prototype && c.forEach(function(_) {
            ...
            try {
                if (I.hasOwnProperty(_)) {
                    ...
                    x && x.value ? (x.value = e.wrapWithCurrentZone(x.value, P), e._redefineProperty(m.prototype, _, x)) : I[_] && (I[_] = e.wrapWithCurrentZone(I[_], P))
...
function Zt(e) {
    e.__load_patch("util", (n, a, t) => {
        let c = Ze(n);
        t.patchOnProperties = ot, t.patchMethod = de, t.bindArguments = Fe, t.patchMacroTask = pt;
        let f = a.__symbol__("BLACK_LISTED_EVENTS"),
            E = a.__symbol__("UNPATCHED_EVENTS");
        n[E] && (n[f] = n[E]), n[f] && (a[f] = a[E] = n[f]), t.patchEventPrototype = wt, t.patchEventTarget = Pt, t.isIEOrEdge = vt, t.ObjectDefineProperty = Ae, t.ObjectGetOwnPropertyDescriptor = be, t.ObjectCreate = Et, t.ArraySlice = Tt, t.patchClass = ve, t.wrapWithCurrentZone = Ve, t.filterProperties = ut, t.attachOriginToPatched = _e, t._redefineProperty = Object.defineProperty, t.patchCallbacks = Mt, t.getGlobalObjects = () => ({
            globalSources: st,
